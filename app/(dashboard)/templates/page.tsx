...
// ── Single unified card — used for every tab ──────────────────────────────────
function MarketplaceCard({
  ...
  return (
    ...
    >
      {/* Thumbnail — fixed 2:3 ratio for all cards */}
      ...
      <div className={cn(
        ...
        {description && <p className="text-[11px] text-brand-text/40 leading-snug">{description}</p>}
      </div>
    </div>
  )
}
