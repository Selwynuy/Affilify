...
export const VIDEO_MODELS: VideoModel[] = [
  ...
  },
  {
    ...
    qualityLabel: 'Elite',
    minPlanId: 'business',
    description: 'State-of-the-art video with Standard and Pro modes plus optional native audio.',
  ...
  },
  {
    ...
    qualityLabel: 'Elite',
    minPlanId: 'business',
    description: "Google's cinematic model with 720p and 1080p output plus optional native audio.",
